...
export function Logo({ className, variant = "full", inverted = false }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      <span className="font-display text-sm xs:text-base sm:text-2xl tracking-[0.15em] uppercase leading-none pl-[0.15em]">
        RENAISSANCE
      </span>
      ...
      {variant === "full" && (
        <>
          ...
          <div className="flex flex-col items-center font-display text-[0.35rem] xs:text-[0.42rem] sm:text-[0.55rem] tracking-[0.15em] sm:tracking-[0.2em] uppercase leading-tight">
            <span>MEETINGS</span>
